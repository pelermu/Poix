![Graph-Logo](https://i.imgur.com/F0GGemj.png)
# Poix Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Poix Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/qYa69rD)
***
## Requirements
1) **1,000 Poix coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Poix/master/poix_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash poix_install.sh`
...
***Step 1***
* Download and install the Poix wallet [here](http://www.poix.online/wallet/)
***

***Step 2***
* Send EXACLY 1,000 POIX to a receive address within your wallet.
***
